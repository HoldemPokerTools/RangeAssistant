...
import { Layout, Modal, Space, Input, Button, Form, message, Typography, Alert } from 'antd';
...
const onExport = (data) => {
  ...
  const url = window.URL.createObjectURL(new Blob([JSON.stringify(range)], {
  ...
  return (
    <Layout style={{ minHeight: '100vh' }}>
      <Header className="site-layout-header">
        <img alt="logo" height="40" src="https://user-images.githubusercontent.com/42975160/92998271-b8630380-f510-11ea-843d-bb5ec3ec4ae0.png"/>
        ...
        <Space>
          ...
          <Button onClick={() => setVisible(true)} disabled={!isExportable} type="primary">
      ...
      <Content className="content">
        <div className="site-layout-content">
          {
            !localStorage.getItem('showIntro') && <Alert
              type="info"
              closable
              afterClose={() => {
      ...
      <Modal
        ...
        >
          <Form
            ...
            form={form}
          >
            <Form.Item label="Range Name" required name="title" rules={[{ required: true, message: 'Please input a valid name for this range', min: 1, max: 24 }]}>
              <Input placeholder="6 Max Cash UTG RFI"/>
            </Form.Item>
            <Form.Item label="Range Author" required name="author" rules={[{ required: true, message: 'Please input an author for this range', min: 1, max: 16 }]}>
      ...
      <Footer style={{ textAlign: 'center' }}>
        ...
        <br/>
        <Text>Hold'em tools are free for everyone to use. Show you support on Buy Me a Coffee!</Text>
        <br/>
        <Space>
          <Link href="https://www.buymeacoffee.com/holdemtools" target="_blank"><img src="https://cdn.buymeacoffee.com/buttons/default-red.png" alt="Buy Me A Coffee" style={{height: 41, width: 174, borderRadius: 5}} /></Link>
          <Link href="https://github.com/HoldemTools/RangeAssistant" target="_blank"><GithubOutlined/> View on GitHub</Link>
        </Space>
      </Footer>
    </Layout>
  )
